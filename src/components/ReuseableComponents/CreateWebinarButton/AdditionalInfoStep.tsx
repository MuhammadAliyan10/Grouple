...
const AdditionalInfoStep = (props: Props) => {
  const { formData, updateAdditionInfoField, getStepValidationErrors } =
    useWebinarStore();
  ...
  const handleToggleLockChat = (checked: boolean) => {
    updateAdditionInfoField("lockChat", checked);
  };
  const handleToggleCoupon = (checked: boolean) => {
    updateAdditionInfoField("couponEnabled", checked);
  };
  const handleCouponCodeChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    updateAdditionInfoField("couponCode", e.target.value);
  };
  return (
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400">
            Turn it on to make chat visible to your all users at all time.
          </p>
        </div>
        <Switch
          id="lock-chat"
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-400">
              Turn it on to offer discount to your customers.
            </p>
          </div>
          <Switch
            id="coupon-enabled"
        ...
        {couponEnabled && (
          <div className="space-y-2">
            ...
            <div className="flex items-start gap-2 text-sm text-gray-400 mt-2">
              ...
              <p>
                This coupon code can be used to promote the sale. User can use
